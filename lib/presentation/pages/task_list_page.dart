...
class _TaskScreenState extends State<TaskScreen> {
  ...
  void initState() {
    super.initState();
    context.read<TaskBloc>().add(LoadTasks()); // ✅ Load tasks when screen opens
  }
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    trailing: Row(
                      ...
                      children: [
                        IconButton(
                          icon: Icon(Icons.edit_note_rounded, color: Colors.black, size: 28),
        ...
        onPressed: () async {
          ...
          if (currentState.users.isNotEmpty) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text("Failed to load users. Try again.")),
            );
          }
        },
